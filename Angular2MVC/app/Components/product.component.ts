    ...
    onSubmit(formData: any) {
        ...
        switch (this.dbops) {
            ...
            case DBOperation.update:
                this._productService.put(Global.BASE_PRODUCT_ENDPOINT, formData._value.ProductId, formData._value).subscribe(
                    data => {
                        if (data == 1) //Success
                        {
            ...
            case DBOperation.delete:
                this._productService.delete(Global.BASE_PRODUCT_ENDPOINT, formData._value.ProductId).subscribe(
                    data => {
                        if (data == 1) //Success
                        {
